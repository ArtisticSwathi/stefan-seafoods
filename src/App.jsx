...
export default function App() {
  ...
  if (view === 'admin') {
    return <AdminPanel products={products} onToggleStock={toggleStock} onExit={() => setView('main')} />;
  }
    ...
    <>
      ...
      <div style={{ fontFamily: 'sans-serif', position: 'relative' }}>
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh',
          background: 'linear-gradient(135deg, #1ca3de 0%, #7ed0f5 70%, #ffffff 98%)', zIndex: -1 }} />

        {/* ALL CONTENT — zIndex 1, handles all clicks */}
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          {view === 'checkout' ? (
            ...
            <div>
              ...
              <div id="shop" style={{
                ...
                <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>
                  <button onClick={() => setFilter('all')} style={{
                    padding: isMobile ? '9px 18px' : '11px 26px', borderRadius: '25px', border: '2px solid',
                  ...
                  {categories.map(cat => {
                    ...
                    return (
                      <button key={cat} onClick={() => setFilter(cat)} style={{
                        ...
                        fontWeight: '700', cursor: 'pointer', fontFamily: 'inherit',
                        fontSize: isMobile ? '0.85rem' : '0.95rem', textTransform: 'capitalize',
                        touchAction: 'manipulation',
                      }}>{emoji} {cat.charAt(0).toUpperCase() + cat.slice(1)}</button>
                    );
                  })}
                </div>
              ...
              {/* WhatsApp FAB */}
              <button onClick={() => window.open('https://wa.me/911234567891', '_blank')}
                style={{
                  ...
                  border: 'none', padding: 0, touchAction: 'manipulation',
                }}>
        ...
        {/* Truck — on top visually, but completely isolated with pointerEvents none on BOTH wrapper and canvas style */}
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh',
